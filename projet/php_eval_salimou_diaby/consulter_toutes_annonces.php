...
$pdostat = $pdo->query("SELECT * FROM advert ORDER BY id DESC");
            ...
            <div class="col-sm-6 mb-3 mb-sm-0">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a class="btn btn-primary" href="consulter_une_annonce.php?id=<?php echo $annonce['id']?>">Consulter cette annonce</a>
